    ...
    private final String host;
     private final int port;
             ...
             public static void main(String[] args) throws Exception {
                 ...
                 //System.out.println("-------parentThreadGroupSize----"+args[0]);
                 //System.out.println("-------childThreadGroupSize----"+args[1]);


                 new HttpClient("localhost", 8088).start(); // 连接127.0.0.1/65535，并启动
             }
}
